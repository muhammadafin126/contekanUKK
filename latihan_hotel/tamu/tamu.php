...
<body>
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
	...
	<!-- Content title -->
    <h3 class="sia-main fw-bold text-capitalize my-5" data-aos="fade-right"><b>tamu</b></h1>
	<div class="sia-box sia-shadow mb-4" data-aos="zoom-in">
	<table class="table">
		<tr>
			<th scope="col" class="sia-main">#</th>
			<th scope="col" class="sia-main">Nama</th>
			<th scope="col" class="sia-main">Alamat</th>
			<th scope="col" class="sia-main">HP</th>
            <th scope="col" class="sia-main">Gender</th>
