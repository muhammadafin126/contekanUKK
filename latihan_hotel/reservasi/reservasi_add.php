...
$view = $konek->query('SELECT * FROM reservasi');
...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($konek, "INSERT INTO reservasi VALUES (NULL,'$id_tamu','$id_kamar','$tgl_in','$tgl_out','$biaya')");
            ...
            <div class="form-body">
               <div class="form-group">
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="sialahkan isi id_tamu" name="id_tamu"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="sialahkan isi id_kamar" name="id_kamar"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="date" class="form-control" placeholder="masukan tgl_in" name="tgl_in"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="date" class="form-control" placeholder="masukan tgl_out" name="tgl_out"/>
                  </div>
