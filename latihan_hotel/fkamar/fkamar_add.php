...
$view = $konek->query('SELECT * FROM tb_fkamar');
...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($konek, "INSERT INTO tb_fkamar VALUES (NULL,'$tipe','$faselitas')") or die(mysqli_error($konek));
            ...
            <div class="form-body">
               <div class="form-group">
                   <div class="my-4 d-flex sia-input">
                       <input type="text" class="form-control" placeholder="masukan tipe" name="tipe"/>
                    </div>
                    <div class="my-4 d-flex sia-input">
                       <input type="text" class="form-control" placeholder="sialahkan isi faselitas" name="faselitas"/>
                    </div>
