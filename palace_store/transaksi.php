...
<head>
	<meta charset="utf-8">
	<tittle>Palace Store | transaksi</tittle>
	<!-- CSS only -->
...
<body>
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
	...
	<!-- Content title -->
    <h3 class="sia-main fw-bold text-capitalize my-3" data-aos="fade-right"><b>transaksi</b></h1>
	<div class="sia-box sia-shadow mb-4"  data-aos="zoom-in">
	<table class="table">
		<tr>
			<th scope="col" class="sia-main">ID Transaksi</th>
			<th scope="col" class="sia-main">Tanggal</th>
			<th scope="col" class="sia-main">Nomor</th>
			<th scope="col" class="sia-main">Nama</th>
			<th scope="col" class="sia-main">Bayar</th>
            <th scope="col" class="sia-main">Kembali</th>
		</tr>
		<?php
		include 'config.php';
		$no=1;
