...
<body>
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
	...
	<!-- Content title -->
	<form class="sia-form my-5" action="user_add.php" method="post" autocomplete="off" data-aos="zoom-in">
            <div class="form-header">
               <h3 class="text-capitalize open-sans text-sia-main fw-bold">form tambah user</h3>
               <p class="text-capitalize text-sia-grey open-sans">silahkan tambahkan user</p>
            </div>
            <div class="form-body">
               <div class="form-group">
                   <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan nama user" name="nama" />
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan username user" name="username"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan password user" name="password"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan role id user" name="role_id"/>
                  </div>
        ...
        if (isset($_POST['simpan'])) {
         ...
         //this what you do
           mysqli_query($dbconnect, "INSERT INTO user VALUE (NULL,'$nama','$username','$password','$role_id')");
           //this where you send it
