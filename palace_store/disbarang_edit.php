  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
	...
	<form class="sia-form my-5" action="" method="post" autocomplete="off" data-aos="zoom-in">
            <div class="form-header">
               <h3 class="text-capitalize open-sans text-sia-main fw-bold">form edit diskon</h3>
               <p class="text-capitalize text-sia-grey open-sans">silahkan edit diskonr</p>
            </div>
            <div class="form-body">
               <div class="form-group">
                  ...
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan batas nominal" name="qty" value="<?=$data['qty']?>"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan nominal potongan" name="potongan" value="<?=$data['potongan']?>"/>
                  </div>
                  <div class="btn-group d-flex">
                     <input type="submit" name="update" class="btn-main text-capitalize open-sans my-4" value="update"></input>
                  </div>
               </div>
            </div>
         </form>
