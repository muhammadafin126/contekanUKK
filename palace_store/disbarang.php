...
<head>
	<meta charset="utf-8">
	<tittle>Palace Store | Disbarang</tittle>
	<!-- CSS only -->
...
<body>
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
	...
	<div class="container my-5">
        ...
        ?>
	<!-- Content title -->
    <h3 class="sia-main fw-bold text-capitalize my-3"  data-aos="fade-right"><b>discount</b></h1>
	<div class="sia-box sia-shadow mb-4"  data-aos="zoom-in">
	<table class="table">
		<tr>
			<th scope="col" class="sia-main">ID</th>
			<th scope="col" class="sia-main">Barang</th>
			<th scope="col" class="sia-main">Qty</th>
			<th scope="col" class="sia-main">Potongan</th>
		...
		while ($row = $view->fetch_array()) { ?>
			...
			<td><?= $row['potongan']?></td>
			<td>
				<a href="disbarang_edit.php?id=<?php echo $row['id']?>" class="btn-link-main">
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  					<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  					<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
					</svg>
				</a>
				<a href="disbarang_delete.php?id=<?php echo $row['id']?>" class="btn-link-danger">
