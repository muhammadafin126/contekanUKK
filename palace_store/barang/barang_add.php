...
<body>
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
	...
	<!-- Content title -->
	<form class="sia-form my-5" action="barang_add.php" method="post" name="form_barang" autocomplete="off" data-aos="zoom-in">
            <div class="form-header">
               <h3 class="text-capitalize open-sans text-sia-main fw-bold">form tambah barang</h3>
               <p class="text-capitalize text-sia-grey open-sans">silahkan tambahkan barang</p>
            </div>
            <div class="form-body">
               <div class="form-group">
                  ...
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan kode barang" name="kode_barang"/>
                  </div>
        ...
        if (isset($_POST['simpan'])) {
         ...
         //this what you do
           mysqli_query($dbconnect, "INSERT INTO barang VALUE (NULL,'$nama','$harga','$jumlah','$kode_barang')");
