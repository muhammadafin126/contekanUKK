...
<head>
	<meta charset="utf-8">
	<tittle>Palace Store | Tambah Barang</tittle>
	<!-- CSS only -->
	...
	<div class="container my-5 col-md-6">
           <form class="sia-form my-5" method="post" autocomplete="off" data-aos="zoom-in">
            <div class="form-header">
               <h3 class="text-capitalize open-sans text-sia-main fw-bold">form edit barang</h3>
               <p class="text-capitalize text-sia-grey open-sans">silahkan edit barang</p>
            </div>
            <div class="form-body">
               <div class="form-group">
                   <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan nama barang" name="nama" value="<?=$data['nama']?>"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan kode barang" name="kode_barang" value="<?=$data['kode_barang']?>"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan harga barang" name="harga" value="<?=$data['harga']?>"/>
                  </div>
                  <div class="my-4 d-flex sia-input">
                     <input type="text" class="form-control" placeholder="masukan jumlah barang" name="jumlah" value="<?=$data['jumlah']?>"/>
                  </div>
